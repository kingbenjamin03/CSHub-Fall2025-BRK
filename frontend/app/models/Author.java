...
public class Author {
     ...
     */
    public static Author deserialize(JsonNode json) throws Exception {
        if (json == null) {
            throw new NullPointerException("Author node should not be null to be serialized.");
        }
        Author oneUser = Json.fromJson(json, Author.class);
