...
//	private String highestDegree;
	...
	@Column(name="mood", columnDefinition="varchar(25) NOT NULL DEFAULT 'neutral'")
	private String mood;
	...
	public User(String userName, String password, String firstName,
				String lastName, String middleName, String organization,
...
//		List<Organization> organizations = this.getOrganizations();
	...
	public void deserializeFromJson(JsonNode json) throws Exception {
		...
		if (json.path("middleName") != null) this.setMiddleName(json.path("middleName").asText());
